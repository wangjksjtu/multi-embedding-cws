...
def main(unused_argv):
    ...
    with graph.as_default():
        ...
        P_pinyin, sequence_length_pinyin = inference(X_pinyin, initial_args[5], initial_args[6], type="pinyin", trainMode = False)
        P_wubi, sequence_length_wubi = inference(X_wubi, initial_args[7], initial_args[8], type="wubi", trainMode = False)
