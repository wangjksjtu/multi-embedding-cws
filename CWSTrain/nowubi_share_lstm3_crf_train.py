...
def main(unused_argv):
    ...
    with graph.as_default():
        initial_args = initialization(FLAGS.word2vec_path, FLAGS.pinyin2vec_path)
        inp_char, inp_pinyin = initial_args[0:2]
        ...
        P_pinyin, sequence_length_pinyin = inference(X_pinyin, initial_args[4], initial_args[5], type="pinyin", trainMode = False)
        ...
        test_unary_score_pinyin, test_sequence_length_pinyin = inference(inp_pinyin,initial_args[4], initial_args[5],
                                                                         reuse = True, trainMode = False, type = 'pinyin') #fix

        test_unary_score = test_unary_score_char + test_unary_score_pinyin
