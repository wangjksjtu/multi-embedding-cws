...
def main(unused_argv):
    ...
    with graph.as_default():
        inp_char, inp_wubi, hidden_W, hidden_b, hidden_W_fc, hidden_b_fc = initialization(FLAGS.word2vec_path, FLAGS.wubi2vec_path)
        ...
        final_vectors = inference_fc(X_char, X_wubi, hidden_W_fc, hidden_b_fc)
        ...
        test_final_vectors = inference_fc(inp_char, inp_wubi, hidden_W_fc, hidden_b_fc)
